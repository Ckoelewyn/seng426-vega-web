...
router.post("/upload", (req,res) => {
    ...
    uploader("http://spring-backend:8080/venus/admin/handlefileupload", formData, req.headers)
    		.then(response => {
...
router.get("/listfiles", (req, res) => {
	...
	listFiles("http://spring-backend:8080/venus/files/listfiles", req.headers)
	.then(response => {
    	console.log("Response", response);
    	res.send(response);
    })
...
router.get("/fetchcontent", (req, res) => {
	...
	console.log(name)
	fetchcontent("http://spring-backend:8080/venus/files/fetch/"+name, req.headers)
	.then(response => {
    	console.log("Response", response);
    	res.send(response);
    })
